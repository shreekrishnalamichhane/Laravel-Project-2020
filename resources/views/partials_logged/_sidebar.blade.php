        ...
        <ul class="collapsible collapsible-accordion">
          ...
          <li>
            ...
            <div class="collapsible-body">
              <ul>
                <li>
                  <a href="v-1.html" class="waves-effect">Version 1</a>
                </li>
                <li>
                  <a href="v-2.html" class="waves-effect">Version 2</a>
                </li>
                <li>
                  <a href="v-3.html" class="waves-effect">Version 3</a>
                </li>
                <li>
                  <a href="v-4.html" class="waves-effect">Version 4</a>
                </li>
                <li>
                  <a href="v-5.html" class="waves-effect">Version 5</a>
                </li>
                <li>
                  <a href="v-6.html" class="waves-effect">Version 6</a>
                </li>
              </ul>
            </div>
          </li>
